...
<b>Quantity    &nbsp &nbsp &nbsp &nbsp &nbsp: </b><!--input name="publisher" --><br/><hr/>
...
<a href="../admin/booklist.php"><button type="button">Delete</button></a>
<!--input type="reset" value="Reset"/-->&nbsp
<!--a href="../admin/viewpro-del.php"><button type="button">Delete</button></a-->
&nbsp <a href="../admin/booklist.php">go back?</a>
