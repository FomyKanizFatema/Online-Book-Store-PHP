		...
		<header>
			<table width="100%" align="center" border="0">
				...
				<tr id="row1" >
					<td  width="100%" height="40px" align="right"> 
						<a href="userHome.php" ><font color="ffffff">Home</font></a> &nbsp;&nbsp;
						<a href="../Home/home.php"><font color="ffffff">Log Out</font></a> &nbsp;&nbsp; 
			...
			<table border="0" width="100%">
				...
				<tr>
					...
					<td align="center">
						<button id="user" ></button>&nbsp;&nbsp;&nbsp;&nbsp;<br/><br/>
						<button id="wishlist"></button>&nbsp;&nbsp;&nbsp;&nbsp;
						<button id="cart">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<br/><font><b>Welcome Fomy Kaniz Fatema !</b></font><br/>
